...
var Main = {
    ...
    mounted() {
        // if($.cookie("economicSituationUpload")!='undefined'&&$.cookie("economicSituationUpload")!=''&&$.cookie("economicSituationUpload")!=null){
        //     this.$refs['economicSituationUpload'].uploadFiles=JSON.parse( $.cookie("economicSituationUpload"))
        //     this.getFileList(this.$refs['economicSituationUpload'].uploadFiles)
        // }
        // if($.cookie("proofOfDiagnosisUpload")!='undefined'&&$.cookie("proofOfDiagnosisUpload")!=''&&$.cookie("proofOfDiagnosisUpload")!=null){
        //     this.$refs['proofOfDiagnosisUpload'].uploadFiles=JSON.parse( $.cookie("proofOfDiagnosisUpload"))
        //     this.getFileList(this.$refs['proofOfDiagnosisUpload'].uploadFiles)
        // }
        // if($.cookie("paymentReceiptUpload")!='undefined'&&$.cookie("paymentReceiptUpload")!=''&&$.cookie("paymentReceiptUpload")!=null){
        //     this.$refs['paymentReceiptUpload'].uploadFiles=JSON.parse( $.cookie("paymentReceiptUpload"))
        //     this.getFileList(this.$refs['paymentReceiptUpload'].uploadFiles)
        // }
        // if($.cookie("patientPhotosUpload")!='undefined'&&$.cookie("patientPhotosUpload")!=''&&$.cookie("patientPhotosUpload")!=null){
        //     this.$refs['patientPhotosUpload'].uploadFiles=JSON.parse( $.cookie("patientPhotosUpload"))
        //     this.getFileList(this.$refs['patientPhotosUpload'].uploadFiles)
        // }
        // if($.cookie("memberOfFamilyUpload")!='undefined'&&$.cookie("memberOfFamilyUpload")!=''&&$.cookie("memberOfFamilyUpload")!=null){
        //     this.$refs['memberOfFamilyUpload'].uploadFiles=JSON.parse( $.cookie("memberOfFamilyUpload"))
        //     this.getFileList(this.$refs['memberOfFamilyUpload'].uploadFiles)
        // }
    ...
    methods: {
        ...
        economicSituationSuccess(response, file, fileList) {
            ...
            //移除上传进度条
            let process = document.getElementById("economicSituationProcess")
            process.remove()
            this.fileFlag.economicSituation = true
            ...
            $.cookie("economicSituationUpload", value, {expires: 7})
        ...
        proofOfDiagnosisSuccess(response, file, fileList) {
            ...
            //移除上传进度条
            let process = document.getElementById("proofOfDiagnosisProcess")
            process.remove()
            this.fileFlag.proofOfDiagnosis = true
            ...
            //设置cookie
            let value=JSON.stringify(fileList)
            $.cookie("proofOfDiagnosisUpload", value, {expires: 7})
        ...
        paymentReceiptSuccess(response, file, fileList) {
            ...
            //移除上传进度条
            let process = document.getElementById("paymentReceiptProcess")
            process.remove()
            this.fileFlag.paymentReceipt = true
            ...
            //设置cookie
            let value=JSON.stringify(fileList)
            $.cookie("paymentReceiptUpload", value, {expires: 7})
        ...
        patientPhotosSuccess(response, file, fileList) {
            ...
            //移除上传进度条
            let process = document.getElementById("patientPhotosProcess")
            process.remove()
            this.fileFlag.patientPhotos = true
            ...
            //设置cookie
            let value=JSON.stringify(fileList)
            $.cookie("patientPhotosUpload", value, {expires: 7})
        ...
        memberOfFamilySuccess(response, file, fileList) {
            ...
            //移除上传进度条
            let process = document.getElementById("memberOfFamilyProcess")
            process.remove()
            this.fileFlag.memberOfFamily = true
            ...
            //设置cookie
            let value=JSON.stringify(fileList)
            $.cookie("memberOfFamilyUpload", value, {expires: 7})
        ...
        handleRemove(file) {
            ...
            if (!(typeof (file.response) === 'undefined')) {
                ...
                let value=JSON.stringify(fileList)
                $.cookie(oldFile[0].category + 'Upload', value, {expires: 7})
        ...
        getFileList(fileList) {
            for (let i = 0; i < fileList.length; i++) {
                this.fileList.push({
                    ...
                    category: fileList[i].response.data.category,
                })
            }
        }
    }
